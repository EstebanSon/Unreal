...
FName BATTERYCOLLECTOR_WasCollected = FName(TEXT("WasCollected"));
	...
	IMPLEMENT_CLASS(ABatteryCollectorCharacter, 2876371370);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EBatteryPlayState(EBatteryPlayState_StaticEnum, TEXT("/Script/BatteryCollector"), TEXT("EBatteryPlayState"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(ABatteryCollectorGameMode, 1440004207);
	...
	IMPLEMENT_CLASS(APickup, 393342524);
	void ABatteryPickup::StaticRegisterNativesABatteryPickup()
	{
	}
	IMPLEMENT_CLASS(ABatteryPickup, 3141519984);
	void ASpawnVolume::StaticRegisterNativesASpawnVolume()
	{
		FNativeFunctionRegistrar::RegisterFunction(ASpawnVolume::StaticClass(), "GetRandomPointVolume",(Native)&ASpawnVolume::execGetRandomPointVolume);
	...
	IMPLEMENT_CLASS(ASpawnVolume, 600002099);
...
// Cross Module References
	...
	BATTERYCOLLECTOR_API class UFunction* Z_Construct_UFunction_ASpawnVolume_GetRandomPointVolume();
	...
	UFunction* Z_Construct_UFunction_ABatteryCollectorCharacter_GetInitialPower()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Power"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("BatteryCollectorCharacter.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Accessor function for initail power"));
#endif
		}
		return ReturnFunction;
	}
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABatteryCollectorCharacter_GetInitialPower(), "GetInitialPower"); // 769042060
				...
				MetaData->SetValue(NewProp_SpeedFactor, TEXT("ToolTip"), TEXT("Multiplier when power level = 0"));
	...
	UEnum* Z_Construct_UEnum_BatteryCollector_EBatteryPlayState()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBatteryPlayState::EPlaying")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBatteryPlayState::EGameOver")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBatteryPlayState::EWon")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBatteryPlayState::EUnknown")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EBatteryPlayState::EBatteryPlayState_MAX")), 4));
	...
	uint32 Get_Z_Construct_UEnum_BatteryCollector_EBatteryPlayState_CRC() { return 3659594038U; }
	UFunction* Z_Construct_UFunction_ABatteryCollectorGameMode_GetCurrentState()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Returns the current palying state"));
#endif
		}
		return ReturnFunction;
	}
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABatteryCollectorGameMode_GetCurrentState(), "GetCurrentState"); // 2353981794
	...
	UFunction* Z_Construct_UFunction_APickup_IsActive()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("/ Return wheter or not the pickup is active"));
#endif
		}
		return ReturnFunction;
	}
	...
	UFunction* Z_Construct_UFunction_APickup_WasCollected()
	{
		...
		if (!ReturnFunction)
		{
			...
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Pickup.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Funjction to call when the pickup is colledted"));
#endif
		}
		return ReturnFunction;
	}
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APickup_IsActive(), "IsActive"); // 4129520183
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APickup_SetActive(), "SetActive"); // 2962234522
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APickup_WasCollected(), "WasCollected"); // 2741170337
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_ASpawnVolume_GetRandomPointVolume()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetRandomPointVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x14820401, 65535, sizeof(SpawnVolume_eventGetRandomPointVolume_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ReturnValue, SpawnVolume_eventGetRandomPointVolume_Parms), 0x0010000000000580, Z_Construct_UScriptStruct_FVector());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_ASpawnVolume()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_ASpawnVolume_GetRandomPointVolume());
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ASpawnVolume_GetRandomPointVolume(), "GetRandomPointVolume"); // 3464793930
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ASpawnVolume_SetSpawningActive(), "SetSpawningActive"); // 3397706753
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
